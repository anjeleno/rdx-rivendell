#!/usr/bin/env python3
"""
RDX Professional Broadcast Control Center v3.7.7
...
class RDXBroadcastControlCenter(QMainWindow):
    ...
    def __init__(self):
        super().__init__()
        self.setWindowTitle("RDX Professional Broadcast Control Center v3.7.7")
    ...
    def setup_ui(self):
        ...
        # Status bar
        self.statusBar().showMessage("Ready - Professional Broadcast Control Center v3.7.7")
